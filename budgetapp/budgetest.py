#ASSIGNMENT 3 BUDGET APP TEST FILE
...
class UnitTests(unittest.TestCase):
    def setUp(self):
        exec('{}={}'.format('{}{}'.format('self', '.food'), '{}{}'.format('budget', '.category("Food")')))
        #self.food = budget.Category("Food")
        exec('{}={}'.format('{}{}'.format('self', '.entertainment'), '{}{}'.format('budget', '.category("Entertainment")')))
        #self.entertainment = budget.Category("Entertainment")
        exec('{}={}'.format('{}{}'.format('self', '.business'), '{}{}'.format('budget', '.category("Business")')))
