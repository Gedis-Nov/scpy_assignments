...
class UnitTests(unittest.TestCase):
    def setUp(self):
        self.rect = shape_calc.Rectangle(3, 6)
        self.sq = shape_calc.Square(5)

    def test_subclass(self):
        actual = issubclass(shape_calc.Square, shape_calc.Rectangle)
        expected = True
        self.assertEqual(actual, expected, 'Expected Square class to be a subclass of the Rectangle class.')

    def test_distinct_classes(self):
        actual = shape_calc.Square is not shape_calc.Rectangle
        expected = True
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, shape_calc.Square) and isinstance(self.sq, shape_calc.Rectangle)
        expected = True
    ...
    def test_get_amount_inside_two_rectangles(self):
        rect2 = shape_calc.Rectangle(4, 8)
    ...
    def test_get_amount_inside_none(self):
        rect2 = shape_calc.Rectangle(2, 3)
        actual = rect2.get_amount_inside(self.rect)
        expected = 0
